...
mod tests {
    ...
    #[case("+81-3-1234-5678")]
    #[case("+81312345678")]
    fn successful_parse_phone_number(#[case] phone_number: &str) {
    ...
    #[case("03 (1234) 5678")]
    #[case("+81312345678")]
    fn successful_parse_japanese_phone_number(#[case] phone_number: &str) {
    ...
    fn japanese_phone_number_format(#[case] mode: Mode, #[case] expected: &str) {
